...
| `elasticsearch.auth.passwordSecretKeyRef.name`       | Name of secret                                                                 | `null`                                             |
| `elasticsearch.auth.passwordSecretKeyRef.key`        | Key within secret containing password                                          | `null`                                             |
